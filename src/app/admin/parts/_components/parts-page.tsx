...
import { type UnifiedPartRow, getUnifiedPartColumns } from "./columns";
import { InventoryExpandedPanel } from "./inventory-expanded-panel";
    ...
    <div className="flex flex-col gap-6">
      ...
      {isLoading ? (
        ...
        <DataTable
          ...
          initialColumnVisibility={{ inventorySearchText: false, location: false, allocationStatus: false }}
